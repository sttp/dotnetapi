...
namespace sttp.communication
{
    ...
    public class TlsServer : ServerBase
    {
        ...
        {
            get => m_ignoreInvalidCredentials;
            set => m_ignoreInvalidCredentials = value;
        }
        ...
        {
            get => m_allowDualStackSocket;
            set => m_allowDualStackSocket = value;
        }
        ...
        /// </summary>
        [Browsable(false)]
        public Socket Server => m_tlsServer;
        ...
        {
            get => m_remoteCertificateValidationCallback;
            set => m_remoteCertificateValidationCallback = value;
        }
        ...
        {
            get => m_localCertificateSelectionCallback;
            set => m_localCertificateSelectionCallback = value;
        }
        ...
        {
            get => m_requireClientCertificate;
            set => m_requireClientCertificate = value;
        }
        ...
        {
            get => m_checkCertificateRevocation;
        ...
        {
            get => m_trustedCertificatesPath;
            set => m_trustedCertificatesPath = value;
        }
