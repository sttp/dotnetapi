...
namespace sttp.communication
{
    ...
    public class TransportProvider<T>
    {
        ...
        /// </summary>
        public int SendBufferSize => (object)m_sendBuffer != null ? m_sendBuffer.Length : 0;
        ...
        /// </summary>
        public int ReceiveBufferSize => (object)m_receiveBuffer != null ? m_receiveBuffer.Length : 0;
