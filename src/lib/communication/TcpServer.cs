...
namespace sttp.communication
{
    ...
    public class TcpServer : ServerBase
    {
        ...
        /// </summary>
        [Browsable(false)]
        public Socket Server => m_tcpServer;

        /// <summary>
        /// Gets the receive handler used to handle data received on the connected sockets.
        /// </summary>
        private EventHandler<SocketAsyncEventArgs> ReceiveHandler => m_payloadAware ? m_receivePayloadAwareHandler : m_receivePayloadUnawareHandler;
