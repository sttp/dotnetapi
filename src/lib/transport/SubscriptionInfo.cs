...
namespace sttp.transport
{
    ...
    public class SubscriptionInfo
    {
        ...
        /// </summary>
        protected SubscriptionInfo(bool throttled = false) => Throttled = throttled;
        ...
        /// <summary>
        /// Gets or sets the interval, in seconds, at which data should be
        /// published when using a throttled subscription.
        /// </summary>
        public double PublishInterval { get; set; } = 1.0;
        ...
        public SubscriptionInfo Copy() => (SubscriptionInfo)MemberwiseClone();
